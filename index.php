    ...
    <div class="container descripcionEmpresa">
        <div class="row">
            ...
            <div class="col-12 col-md itemServicio">
                ...
                <p><strong>Más de 60 productos</strong><br>forman parte de nuestra<br>línea de soluciones</p>
            </div>
            <div class="col-12 col-md itemServicio">
                <img src="img/servicio2.png" height="125" width="125"/>
                <p><strong>Amplia red logística</strong><br>llevamos nuestro<br>productos a todo el país</p>
            </div>
            <div class="col-12 col-md itemServicio">
                <img src="img/servicio3.png" height="125" width="125"/>
                <p><strong>Estamos en todo el país</strong><br>con distribuidores en<br>puntos estratégicos</p>
            </div>
        </div>
    </div>

    <div class="contenedorWhatsapp">
        <a href="https://wa.me/5493514385851?text=Hola,%20quisiera%20recibir%20mas%20información%20sobre%20Quimica%20Ya!" target="_blank" title="Recibí más información"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
    </div>
            <div class="container mt-5"> 
                <div class="row">
                 ...
                 <form id="formularioContacto" action="index.php" method="post">
                    <div class="form-group">
                        <!--<label>Área a la cual se dirige</label>-->
                    </div>
                    <div class="form-group">
             ...
             <div class="col-12 col-md-6 datosContacto">
                ...
                <p>
                    <strong>Tel. Centro de Distribución Córdoba:</strong>
                    <br>
                    (351) 803 - 4167
                </p>
                <p>
                ...
                <p>
                    <strong>Trabaja con Nosotros<br>Recepción de CV:</strong>
                    <br>
